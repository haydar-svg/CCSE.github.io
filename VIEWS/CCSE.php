...
<script>
    ...
    <nav id="nav">
        ...
        <a href="#rentalHalls" class="locationSalle">
            Location de salle
        </a>
        <a href="#eventsTitle" class="contactUs">
            actualités
        </a>
        <a href="#footer" class="contactUs">
            Contactez nous
        </a>
        <div class="navList">
            ...
            <div class="linksPhoneSize" id="linksPhoneSize">
                ...
                <a href="#rentalHalls" class="linkPhone">
                    Location de salle
                </a>
                <a href="#eventsTitle" class="linkPhone">
                    actualités
                </a>
                <a href="#footer" class="linkPhone">
                    Contactez nous
                </a>
            </div>
        </div>
    </nav>
    <div class="firstBlockBackground" id="landingPage">
        <div class="landingPageContainer">
            <div class="landingPageDescriptionContainer">
                <div class="title">
                    cabinet de consulting et services aux entreprises
                </div>
                <div class="companyDescription">
                    LE CABINET CCSE EST UN CABINET INDÉPENDANT SPÉCIALISÉ DANS LE CONSULTING, LA FORMATION, L’ACCOMPAGNEMENT, L’ASSISTANCE, L’ORIENTATION ET LE DÉVELOPPEMENT DU CAPITAL HUMAIN, DEPUIS 2011.
                </div>
            </div>
            <div class="landingPageDesignContainer">
                <div class="subContainer">
                    <div class="designElement5"> CCSE</div>
                    <div class="designElement4">
                        11
                        <span>
                        ans
                    </span>
                    ...
                    <div class="designElement6">
                    </div>
                    <div class="designElement7">
                    </div>
                    <div class="designElement8">
                    </div>
                    <div class="designElement9">
                    </div>
                </div>
            </div>
        </div>
    </div>
    <div class="servicesBlock" id="servicesTitle">
        Services
    </div>
    <div class="serviceContainer" id="services">
        ...
        <a href="./JURIDIQUE" class="service">
            ...
            <div class="serviceDescription">
                Optez pour un accompagnement de qualité pour votre développement et la gestion de vos formalités juridiques. Faites confiance à l'expertise reconnue de nos avocats pour garantir la sécurité de vos stratégies et de vos obligations
            </div>
    ...
    <div class="completeReservationProcessContainer" id="completeReservationProcessContainer">
        <div class="justForScrolling">
            <div class="completeReservationProcess" id="completeReservationProcess">
                ...
                <div class="dateAvailable">
                    La salle est disponible au moment de votre demande
                </div>
                ...
                <div class="inputContainer">
                    ...
                    <select name="equipements" id="equipements" class="completeProcessInput">
                        ...
                        <option value="no"> societe </option>
                    </select>
                </div>
                <label for="numberOfPeople" class="completeProcessLabel">
                    objet de location
                ...
                <div class="finalReservationButton">
                    réservation
                </div>
    ...
    <div class="reservationDateProcess" id="reservationDateProcess">
        <div class="justForScrollingIntoDate">
            <div class="reservation" id="reservation">
                ...
                <div class="dateUnavailable">
                    Malheureusement, la salle n'est pas disponible à la date que vous avez indiquée
                </div>
                <div class="checkButton" onclick="openReservationProcess(event)">
                    vérification
                </div>
            </div>
        </div>
    ...
    <div class="rentalHalls" id="rentalHalls">
    </div>
    <script>
        equipementDetail();
    </script>
