...
<body>
    ...
    <script>
        function vision(element) {
            ...
            $('sectionPara').innerHTML = `  Notre service de ressources humaines est conçu pour aider les entreprises à recruter, à former et à
gérer leur personnel de manière efficace.</br>
Nous comprenons que les ressources humaines sont la clé de la réussite de toute entreprise, c'est
...
manière optimale.
        ...
        function mission(element) {
            ...
            $('sectionPara').innerHTML = ` Que vous cherchiez à recruter de nouveaux employés, à former votre personnel existant ou à
améliorer la gestion de la performance, notre service de ressources humaines est là pour vous
aider.</br>
Nous offrons une gamme de services, y compris le recrutement, la formation, la gestion de la
...
matière de ressources humaines.
        ...
        function objectif(element) {
            ...
            $('sectionPara').innerHTML = ` En choisissant notre service de ressources humaines, vous bénéficiez d'un
accompagnement personnalisé tout au long du processus.</br>
Nous travaillons en étroite collaboration avec vous pour comprendre vos objectifs,
