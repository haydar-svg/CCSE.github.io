...
<body>
    <style>
        .descriptionTitleAndPictures {
            background-image: linear-gradient(#00000088, #00000088), url(../PUBLIC/IMAGES/services/CONSEIL\ JURIDIQUE.jpeg);
        }
    </style>
        ...
        <div class="descriptionTitleAndPictures">
            ...
            <div class="serviceInfoText">
                ...
                <div class="serviceDetail">
                    Optez pour un accompagnement de qualité pour votre développement et la gestion de vos formalités juridiques.
                    </br> Faites confiance à l 'expertise reconnue de nos avocats pour garantir la sécurité de vos stratégies et de vos obligations.</div>
            </div>
        </div>
    ...
    <script>
        function vision(element) {
            ...
            $('sectionPara').innerHTML = `  Nous comprenons que la sécurité juridique est essentielle pour la réussite de votre entreprise, c'est
pourquoi nous travaillons en étroite collaboration avec nos clients pour les aider à comprendre les
implications juridiques de leurs décisions commerciales.</br>
Nos avocats sont des experts dans leur domaine et ont une vaste expérience dans la gestion des
questions juridiques complexes.
        ...
        function mission(element) {
            ...
            $('sectionPara').innerHTML = `  Que vous cherchiez à développer votre entreprise ou à gérer des questions juridiques complexes,
notre service d'accompagnement est là pour vous aider.</br>
Nous offrons une gamme de services, y compris l'aide à la création d'entreprise, la rédaction de
contrats, la négociation de transactions et la résolution de litiges. `;
        ...
        function objectif(element) {
            ...
            $('sectionPara').innerHTML = ` En choisissant notre service d'accompagnement, vous pouvez être sûr de bénéficier d'un
accompagnement de qualité tout au long du processus.</br>
Nos avocats travailleront en étroite collaboration avec vous pour comprendre vos besoins
spécifiques et proposer des solutions pratiques et adaptées à vos besoins. `;
            $(
